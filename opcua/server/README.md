# server - [![Godoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://pkg.go.dev/mod/github.com/NorthlandPowerEurope/dashy/opcua/server) [![License](http://img.shields.io/badge/license-mit-blue.svg?style=flat-square)](https://raw.githubusercontent.com/malivvan/opcua/master/LICENSE)
...
func main() {
	...
	srv, err := server.New(
		ua.ApplicationDescription{
			...
			ProductURI:     "http://github.com/NorthlandPowerEurope/dashy/opcua",
